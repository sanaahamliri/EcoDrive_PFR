        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 max-w-6xl mx-auto">
          ...
          <div className="w-full md:w-2/5 md:pt-16">
            <div className="md:text-left text-center">
              <h2 className="text-4xl font-bold text-white mb-4">Rejoignez EcoDrive</h2>
              <p className="text-white/90 text-xl leading-relaxed">
                Créez votre compte et commencez à voyager ensemble
              </p>

              <div className="hidden md:block mt-12">
                <div className="bg-white/20 backdrop-blur-sm rounded-xl p-6 border border-white/30">
                  <h3 className="text-white text-xl font-semibold mb-3">Pourquoi nous rejoindre ?</h3>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-white mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-white/90">Économisez sur vos trajets quotidiens</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-white mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-white/90">Réduisez votre empreinte carbone</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-white mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-white/90">Rencontrez de nouvelles personnes</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="p-8">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative">
                      <select
                        ...
                        value={formData.role}
                        onChange={handleChange}
                        className="w-full px-4 py-2 pl-10 border border-gray-300 rounded-lg focus:ring-[#12AD90] focus:border-[#12AD90] appearance-none transition-colors"
                      >
                ...
                <div className="mt-6 text-center">
                  <p className="text-sm text-gray-600">
                    ...
                    <Link to="/login" className="font-medium text-[#12AD90] hover:text-[#0e9a7f] transition-colors">
                      Connectez-vous
                    </Link>
                  </p>
                </div>
